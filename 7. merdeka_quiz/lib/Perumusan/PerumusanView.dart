...
class PerumusanView extends StatefulWidget {
  const PerumusanView({super.key});

  get controller => null;

  @override
  _PerumusanViewState createState() => _PerumusanViewState();
}

class _PerumusanViewState extends State<PerumusanView> {
  final PerumusanController controller = PerumusanController();
  String? _selectedAnswer;
  String imagePath = 'assets/perumusan/perumusan1.png';
  ...
  void _handleAnswer(BuildContext context) {
    if (controller.isLastQuestion()) {
      ...
      if (currentIndex == 1) {
        imagePath = 'assets/perumusan/perumusan2.png';
      } else if (currentIndex == 2) {
        imagePath = 'assets/perumusan/perumusan3.png';
      } else if (currentIndex == 3) {
        imagePath = 'assets/perumusan/perumusan4.png';
      } else if (currentIndex == 4) {
        imagePath = 'assets/perumusan/perumusan5.png';
      }
        ...
        return AlertDialog(
          ...
          content: Column(
            children: [
              ...
              const Text('Perumusan Teks Proklamasi.'),
