...
class BPUPKIView extends StatefulWidget {
  const BPUPKIView({super.key});

  get controller => null;

  @override
  _BPUPKIViewState createState() => _BPUPKIViewState();
}

class _BPUPKIViewState extends State<BPUPKIView> {
  final BPUPKIController controller = BPUPKIController();
  String? _selectedAnswer;
  String imagePath = 'assets/bpupki/bpupki1.png';
  ...
  void _handleAnswer(BuildContext context) {
    if (controller.isLastQuestion()) {
      ...
      if (currentIndex == 1) {
        imagePath = 'assets/bpupki/bpupki2.png';
      } else if (currentIndex == 2) {
        imagePath = 'assets/bpupki/bpupki3.png';
      } else if (currentIndex == 3) {
        imagePath = 'assets/bpupki/bpupki4.png';
      } else if (currentIndex == 4) {
        imagePath = 'assets/bpupki/bpupki5.png';
      }
        ...
        return AlertDialog(
          ...
          content: Column(
            children: [
              ...
              const Text('Pembentukan BPUPKI dan PPKI.'),
