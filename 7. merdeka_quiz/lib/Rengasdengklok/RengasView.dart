...
class RengasView extends StatefulWidget {
  const RengasView({super.key});

  get controller => null;

  @override
  _RengasViewState createState() => _RengasViewState();
}

class _RengasViewState extends State<RengasView> {
  final RengasController controller = RengasController();
  String? _selectedAnswer;
  String imagePath = 'assets/rengasdengklok/rengas1.png';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                'assets/rengasdengklok/Header2.png',
                height: 50,
              ),
  ...
  void _handleAnswer(BuildContext context) {
    if (controller.isLastQuestion()) {
      ...
      if (currentIndex == 1) {
        imagePath = 'assets/rengasdengklok/rengas2.png';
      } else if (currentIndex == 2) {
        imagePath = 'assets/rengasdengklok/rengas3.png';
      } else if (currentIndex == 3) {
        imagePath = 'assets/rengasdengklok/rengas4.png';
      } else if (currentIndex == 4) {
        imagePath = 'assets/rengasdengklok/rengas5.png';
      }
        ...
        return AlertDialog(
          ...
          content: Column(
            children: [
              ...
              const Text('Peristiwa Rengasdengklok.'),
